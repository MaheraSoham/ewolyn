          ...
          <div className={`glass-navbar flex items-center justify-between transition-all duration-300 ${isScrolled ? 'px-8 py-4' : 'px-12 py-6 rounded-full'}`}>
            ...
            <Link href="/" className="flex items-center">
              <Image
                ...
                className={`transition-all duration-300 ${isScrolled ? 'h-12' : 'h-20'} w-auto`}
                priority
              />
            </Link>
            ...
            <div className="hidden lg:flex items-center gap-3">
              ...
              <a
                ...
                className="w-10 h-10 rounded-full bg-[#25D366] flex items-center justify-center hover:scale-110 transition-all duration-300 shadow-lg shadow-green-500/20"
              >
              ...
              <a
                ...
                className="w-10 h-10 rounded-full border border-white/30 flex items-center justify-center hover:bg-white hover:text-brand transition-all duration-300"
              >
