                        ...
                        <div>
                            ...
                            <div className="bg-[#1d4380] rounded-[1.25rem] p-5 mb-5 border border-white/5 shadow-inner flex items-stretch">
                                ...
                                <div className="flex-grow flex flex-col justify-center">
                                    ...
                                    <a href="tel:+919737799937" className="flex items-center justify-between group py-1 border-b border-white/10 mb-2 pb-2">
                            ...
                            {/* WhatsApp Card */}
                            <a href="https://wa.me/919737799937" target="_blank" rel="noopener noreferrer" className="bg-[#1d4380] rounded-[1.25rem] p-5 border border-white/5 shadow-inner flex items-center group cursor-pointer hover:bg-[#235099] transition-colors">
