        ...
        <div className="container-max relative z-10 w-full">
          <div className="grid lg:grid-cols-2 gap-14 items-center">
            ...
            >
              ...
              >
                {/* Form header */}
                <div className="px-7 pt-7 pb-5" style={{ background: "linear-gradient(135deg, #1B4F8C 0%, #0d2f57 100%)" }}>
                  <div className="flex items-center gap-2 mb-1">
                    <span className="w-2 h-2 rounded-full bg-[#2eb85c] animate-pulse" />
                    <span className="text-[11px] font-black uppercase tracking-widest text-[#a7f3d0]">Free Eligibility Check</span>
                  </div>
                  <h3 className="text-xl font-black text-white">Check Your Eligibility</h3>
                  <p className="text-sm font-bold text-[#2eb85c] mt-0.5">Get Instant Access — No Cost</p>
                </div>
                ...
                <div className="p-7">
                  {!heroSubmitted ? (
                    <form onSubmit={handleHeroSubmit} className="space-y-4">
                      <div>
                        <label className="text-xs font-bold text-slate-400 uppercase tracking-wider mb-1.5 block">Full Name <span className="text-red-500">*</span></label>
                        <div className="relative">
                          ...
                          <input type="text" required placeholder="Enter your name"
                            className="w-full pl-10 pr-4 py-3 rounded-xl border border-slate-200 bg-slate-50 text-sm text-slate-800 font-medium focus:outline-none focus:border-[#2eb85c] focus:ring-1 focus:ring-[#2eb85c] transition-all"
                            value={heroForm.name} onChange={(e) => setHeroForm({ ...heroForm, name: e.target.value })} />
                        </div>
                      </div>
                      <div>
                        <label className="text-xs font-bold text-slate-400 uppercase tracking-wider mb-1.5 block">Phone Number <span className="text-red-500">*</span></label>
                        <div className="relative">
                          <div className="absolute left-3.5 top-1/2 -translate-y-1/2 text-slate-300">
                      ...
                      <button type="submit" disabled={heroSubmitting}
                        className="w-full py-4 rounded-xl bg-[#2eb85c] hover:bg-[#28a550] text-white font-black text-base transition-all hover:shadow-lg hover:shadow-[#2eb85c]/30 disabled:opacity-70">
                        {heroSubmitting ? (
                  ...
                  {/* Trust row */}
                  <div className="mt-5 pt-4 border-t border-slate-100 flex justify-around text-center">
