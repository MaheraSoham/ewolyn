  ...
  return (
    <main className="min-h-screen bg-slate-50 overflow-x-hidden">
      ...
      <section className="relative pt-20 sm:pt-32 pb-16 sm:pb-28 hero-navy-gradient text-white overflow-hidden">
        ...
        {/* Floating icons */}
        <div className="absolute top-28 right-[14%] w-12 h-12 bg-accent-green/10 rounded-xl rotate-12 flex items-center justify-center text-accent-green/30 animate-float">
        ...
        <div className="container-max relative z-10 text-center">
          ...
          >
            ...
            <span className="text-accent-green">We respond within 24 hours</span>
          </motion.div>
          <motion.h1
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {contactCards.map((card, i) => (
            <motion.a
              ...
              className="group bg-white rounded-2xl shadow-lg p-6 border border-slate-100 hover:border-accent-green/30 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 text-center"
            >
              ...
              <span className="inline-flex items-center gap-1 text-sm font-bold text-accent-green group-hover:translate-x-1 transition-transform">
                {card.btn}
      ...
      <div className="container-max pb-24">
        <div className="grid lg:grid-cols-12 gap-10 items-start">
          ...
          >
            <div className="mb-10">
              <span className="inline-block text-accent-green font-bold text-xs uppercase tracking-widest mb-2">Message Us</span>
              <h2 className="text-3xl font-bold text-slate-900">
                Drop us a line and let&apos;s <span className="text-accent-green">get started.</span>
              </h2>
            </div>
            ...
            {formStatus === "success" ? (
              <div className="min-h-[400px] flex flex-col items-center justify-center text-center p-6 bg-slate-50 rounded-2xl border-2 border-dashed border-slate-200">
                ...
                <button onClick={() => setFormStatus("idle")} className="mt-6 text-accent-green font-bold hover:underline">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <input type="text" name="name" required placeholder="Enter your name" className="w-full bg-slate-50 border border-slate-200 rounded-xl px-5 py-3.5 text-sm focus:border-accent-green focus:ring-1 focus:ring-accent-green transition-all outline-none text-slate-900 font-medium" />
                  </div>
                  <div className="space-y-2">
                    <label className="text-xs font-bold uppercase tracking-wider text-slate-400">Phone Number</label>
                    <input type="tel" name="phone" required placeholder="10-digit mobile" className="w-full bg-slate-50 border border-slate-200 rounded-xl px-5 py-3.5 text-sm focus:border-accent-green focus:ring-1 focus:ring-accent-green transition-all outline-none text-slate-900 font-medium" />
                  </div>
                </div>
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    <label className="text-xs font-bold uppercase tracking-wider text-slate-400">Email Address</label>
                    <input type="email" name="email" required placeholder="your@email.com" className="w-full bg-slate-50 border border-slate-200 rounded-xl px-5 py-3.5 text-sm focus:border-accent-green focus:ring-1 focus:ring-accent-green transition-all outline-none text-slate-900 font-medium" />
                  </div>
                  <div className="space-y-2">
                    <label className="text-xs font-bold uppercase tracking-wider text-slate-400">Inquiry Type</label>
                    <select name="type" className="w-full bg-slate-50 border border-slate-200 rounded-xl px-5 py-3.5 text-sm focus:border-accent-green focus:ring-1 focus:ring-accent-green transition-all outline-none text-slate-900 font-medium appearance-none">
                ...
                <div className="space-y-2">
                  ...
                  <textarea rows={5} name="message" required placeholder="Tell us how we can help your business grow..." className="w-full bg-slate-50 border border-slate-200 rounded-xl px-5 py-3.5 text-sm focus:border-accent-green focus:ring-1 focus:ring-accent-green transition-all outline-none text-slate-900 font-medium resize-none" />
                </div>
                <button
                  type="submit"
                  disabled={formStatus === "submitting"}
                  className="w-full py-4 bg-accent-green text-white font-bold rounded-xl shadow-lg shadow-green-500/20 hover:bg-emerald-600 transition-all disabled:opacity-70 flex items-center justify-center gap-2"
                >
          ...
          >
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 border border-slate-100">
              <h3 className="text-lg font-bold text-slate-900 mb-6 flex items-center gap-2">
                <svg className="w-5 h-5 text-accent-green" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" /></svg>
                What You&apos;ll Get
              </h3>
              <div className="space-y-4">
                {formBenefits.map((b) => (
                  <div key={b.label} className="flex items-center gap-3 text-sm">
                    <div className="w-8 h-8 rounded-lg bg-accent-green/10 text-accent-green flex items-center justify-center shrink-0">{b.icon}</div>
            ...
            <div className="bg-[#0a1628] rounded-2xl p-8 text-white relative overflow-hidden">
              <div className="absolute -top-10 -right-10 w-40 h-40 bg-accent-green/10 rounded-full blur-3xl" />
        ...
        >
          <div className="text-center mb-14">
            <span className="inline-block text-accent-green font-bold text-xs uppercase tracking-widest mb-2">Support FAQ</span>
            <h2 className="text-3xl md:text-4xl font-bold text-slate-900">Common Questions</h2>
          </div>
          <div className="grid gap-6">
            {faqData.map((faq, idx) => (
              <div key={idx} className="bg-white rounded-2xl p-6 md:p-8 border border-slate-100 shadow-sm hover:shadow-lg hover:border-accent-green/20 transition-all flex gap-5 group">
                <div className="w-10 h-10 rounded-xl bg-slate-50 text-accent-green group-hover:bg-accent-green group-hover:text-white flex items-center justify-center shrink-0 transition-colors">
