  ...
  return (
    <main className="min-h-screen bg-slate-50 overflow-x-hidden">
      ...
      <section className="relative pt-32 pb-24 hero-navy-gradient text-white overflow-hidden">
        {/* Floating SVG icons */}
        <div className="absolute top-20 right-[8%] w-16 h-16 bg-accent-green/10 rounded-2xl rotate-12 flex items-center justify-center text-accent-green/30 animate-float">
          ...
          <FadeIn>
            <div className="max-w-3xl mx-auto text-center">
              <div className="inline-flex items-center gap-2 px-5 py-2.5 bg-accent-green/15 backdrop-blur-sm rounded-full text-sm font-bold mb-8 border border-accent-green/25">
                <svg className="w-4 h-4 text-accent-green" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" /></svg>
                <span className="text-accent-green">{governmentSchemes.length}+ Government Schemes Available</span>
              </div>
              <h1 className="text-5xl md:text-7xl font-bold mb-4 leading-[1.1]">
                Government <span className="text-accent-green">Schemes</span>
              </h1>
        ...
        <div className="container-max">
          <FadeIn>
            <div className="text-center mb-10">
              <span className="inline-block text-accent-green font-bold text-xs uppercase tracking-widest mb-2">Simple Process</span>
              <h2 className="text-2xl md:text-3xl font-bold text-slate-900">How It Works</h2>
            </div>
          </FadeIn>
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto relative">
            <div className="hidden md:block absolute top-10 left-[20%] right-[20%] h-px bg-gradient-to-r from-accent-green/0 via-accent-green/30 to-accent-green/0" />
            {steps.map((step) => (
              <SlideUp key={step.num}>
                <div className="text-center relative">
                  <div className="w-20 h-20 mx-auto bg-accent-green/10 rounded-2xl flex items-center justify-center text-accent-green mb-5 relative">
                    {step.icon}
                    <span className="absolute -top-2 -right-2 w-7 h-7 bg-accent-green text-white text-xs font-bold rounded-lg flex items-center justify-center shadow-lg shadow-green-500/20">{step.num}</span>
                  </div>
        ...
        <div className="container-max">
          <div className="flex flex-wrap justify-center gap-2 mb-8">
            <button
              ...
              className={`px-5 py-2.5 rounded-full text-sm font-semibold transition-all duration-200 flex items-center gap-2 ${activeCategory === "All" ? "bg-accent-green text-white shadow-md shadow-green-500/20" : "bg-white text-slate-600 border border-slate-200 hover:border-accent-green/30 hover:text-accent-green"}`}
            >
          ...
          <FadeIn>
            <p className="text-center text-slate-500 mb-12">
              ...
              {activeCategory !== "All" && <> in <span className="font-bold text-accent-green">{activeCategory}</span></>}
            </p>
          </FadeIn>
                    ...
                    <ScaleOnHover>
                      <Link href={`/funding/${scheme.slug}`} className={`group block bg-white rounded-2xl border-t-4 ${meta?.accent || "border-slate-300"} border border-slate-200 hover:shadow-xl transition-all duration-300 h-full overflow-hidden hover:-translate-y-1`}>
                        <div className="p-6 flex flex-col h-full relative">
                          ...
                          <h3 className="text-lg font-bold text-slate-900 mb-2 group-hover:text-accent-green transition-colors leading-snug">{scheme.title}</h3>
                          ...
                          <div className="bg-slate-50 rounded-xl p-4 mb-4">
                            <div className="flex items-center justify-between">
                              <div>
                                ...
                                <p className="text-xl font-black text-accent-green">{scheme.highlight}</p>
                              </div>
                          ...
                          <div className="flex items-center justify-between pt-4 border-t border-slate-100">
                            ...
                            <span className="text-accent-green text-sm font-bold group-hover:translate-x-1 transition-transform flex items-center gap-1">
                              Explore
          ...
          <div className="max-w-3xl mx-auto text-center">
            <FadeIn>
              ...
              <h2 className="text-3xl md:text-4xl font-bold mb-4">
                Need Help Choosing the <span className="text-accent-green">Right Scheme?</span>
              </h2>
