          ...
          <FadeIn>
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-lg text-gray-300 mb-12 max-w-2xl mx-auto leading-relaxed">
                ...
                funding from ₹10K to ₹10Cr with expert guidance.
              </p>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 max-w-4xl mx-auto">
                {[
                  ...
                  { value: "₹10K-₹10Cr", label: "Funding Range", icon: <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg> },
                  ...
                  <div key={s.label} className="bg-white/5 backdrop-blur-sm rounded-3xl p-5 md:p-6 border border-white/10 flex flex-col items-center justify-center">
                    <div className="text-primary mb-3 scale-125">{s.icon}</div>
                    <p className="text-xl md:text-3xl font-bold text-white whitespace-nowrap">{s.value}</p>
                    <p className="text-xs text-white/70 uppercase tracking-widest mt-2">{s.label}</p>
                  </div>
                ))}
              </div>
            </div>
