    ...
    <main className="min-h-screen bg-slate-50">
      ...
      <div className="container-max py-20 relative z-10">
        <div className="grid gap-6 md:grid-cols-2">
          {highlights.map((h) => (
            <div key={h.title} className="card p-8 group hover:border-primary/30 transition-all">
              <h3 className="text-xl font-bold text-ink mb-4 group-hover:text-primary transition-colors">{h.title}</h3>
