...
const whyChooseUs = [
  ...
  },
  {
    ...
    color: "bg-[#0a1628]/20 text-blue-300",
  },
  {
    title: "Flexible Help",
  ...
  return (
    <main className="min-h-screen bg-white overflow-x-hidden">
      ...
      <section className="relative pt-32 pb-24 hero-navy-gradient text-white overflow-hidden">
        ...
        <div className="absolute top-28 right-[12%] w-14 h-14 bg-accent-green/10 rounded-xl rotate-12 flex items-center justify-center text-accent-green/30 animate-float">
        ...
        <div className="container-max relative z-10">
          <div className="max-w-3xl">
            <motion.div
              ...
              className="inline-flex items-center gap-2 px-5 py-2.5 bg-accent-green/15 backdrop-blur-sm rounded-full text-sm font-bold mb-8 border border-accent-green/25"
            >
              <svg className="w-4 h-4 text-accent-green" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z" /></svg>
              <span className="text-accent-green">About Ewolyn</span>
            </motion.div>
            <motion.h1
            ...
            >
              {[
                ...
                <div key={s.label} className="bg-white/5 backdrop-blur-sm rounded-2xl p-4 border border-white/10 text-center">
                  <p className="text-2xl font-bold text-accent-green">{s.value}</p>
        ...
        <div className="container-max">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <motion.div
              ...
              className="relative"
            >
              <div className="absolute -top-10 -left-10 w-40 h-40 bg-accent-green/10 rounded-full blur-3xl -z-10" />
              ...
              {/* Floating stat badge */}
              <div className="absolute -bottom-6 -right-6 bg-[#0a1628] p-6 rounded-2xl shadow-2xl text-white">
                <div className="flex items-center gap-3">
                  <div className="w-12 h-12 rounded-xl bg-accent-green/15 flex items-center justify-center">
                    <svg className="w-6 h-6 text-accent-green" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" /></svg>
                  </div>
                  <div>
                    <p className="text-2xl font-bold text-accent-green">10+</p>
            ...
            >
              <div>
                <motion.span variants={fadeUp} custom={0} className="inline-block text-accent-green font-bold text-xs uppercase tracking-widest mb-2">Our Origin</motion.span>
              ...
              <motion.div variants={fadeUp} custom={4} className="grid grid-cols-2 gap-6 pt-6">
                {[
                  ...
                  <div key={s.label} className="flex items-center gap-3">
                    <div className="w-11 h-11 rounded-xl bg-accent-green/10 flex items-center justify-center shrink-0">{s.icon}</div>
                    <div>
        ...
        <div className="container-max">
          <div className="text-center mb-16">
            <motion.span
              ...
              viewport={{ once: true }}
              className="inline-block text-accent-green font-bold text-xs uppercase tracking-widest mb-2"
            >
              What Drives Us
            </motion.span>
            <motion.h2
          ...
          <div className="grid lg:grid-cols-2 gap-10 items-stretch">
            <motion.div
              ...
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              className="bg-white p-10 rounded-3xl shadow-lg border border-slate-100 group hover:border-accent-green/30 transition-all duration-300 relative overflow-hidden"
            >
              ...
              <div className="relative z-10">
                <div className="w-14 h-14 bg-accent-green/10 rounded-2xl flex items-center justify-center text-accent-green mb-6 group-hover:scale-110 transition-transform">
                  <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M13 10V3L4 14h7v7l9-11h-7z" /></svg>
                </div>
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ delay: 0.1 }}
              className="bg-[#0a1628] p-10 rounded-3xl shadow-lg border border-white/5 group hover:border-accent-green/30 transition-all duration-300 relative overflow-hidden"
            >
              <div className="absolute top-0 right-0 w-32 h-32 bg-accent-green/5 rounded-full -translate-y-1/2 translate-x-1/2 opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
              <div className="relative z-10">
                <div className="w-14 h-14 bg-accent-green/15 rounded-2xl flex items-center justify-center text-accent-green mb-6 group-hover:scale-110 transition-transform">
      ...
      <section className="py-24 bg-white">
        <div className="container-max">
          <div className="text-center mb-16">
            <span className="inline-block text-accent-green font-bold text-xs uppercase tracking-widest mb-2">Our Ethics</span>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {coreValues.map((val, i) => (
              <motion.div
                ...
                variants={fadeUp}
                custom={i}
                className="group p-8 rounded-3xl bg-slate-50 hover:bg-white hover:shadow-xl hover:-translate-y-2 border border-slate-100 hover:border-accent-green/20 transition-all duration-300"
              >
      ...
      <section className="py-24 bg-slate-50">
        <div className="container-max">
          <div className="text-center mb-16">
            <span className="inline-block text-accent-green font-bold text-xs uppercase tracking-widest mb-2">How We Work</span>
            <h2 className="text-4xl md:text-5xl font-bold text-slate-900">
              Ewolyn&apos;s <span className="text-accent-green">Approach</span>
            </h2>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              <motion.div
                ...
                variants={fadeUp}
                custom={i}
                className="group p-8 rounded-3xl bg-white hover:shadow-xl hover:-translate-y-2 border border-slate-100 hover:border-accent-green/20 transition-all duration-300"
              >
                <div className="w-14 h-14 rounded-2xl bg-accent-green/10 flex items-center justify-center mb-6 text-2xl group-hover:scale-110 transition-transform">
                  {item.icon}
                </div>
      ...
      <section className="py-24 hero-navy-gradient text-white relative overflow-hidden">
        ...
        <div className="container-max relative z-10">
          <div className="text-center mb-16">
            <span className="inline-block text-accent-green font-bold text-xs uppercase tracking-widest mb-2">Our Strengths</span>
            <h2 className="text-4xl md:text-5xl font-bold">
              Why Businesses Prefer <span className="text-accent-green">Ewolyn?</span>
            </h2>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {whyChooseUs.map((item, i) => (
              <motion.div
                ...
                variants={fadeUp}
                custom={i}
                className="group bg-white/5 backdrop-blur-sm p-6 rounded-2xl border border-white/10 hover:border-accent-green/30 hover:bg-white/10 transition-all duration-300"
              >
        ...
        <div className="container-max">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <motion.div
              ...
              className="space-y-8"
            >
              <motion.span variants={fadeUp} custom={0} className="inline-block text-accent-green font-bold text-xs uppercase tracking-widest">Our Commitment</motion.span>
              <motion.h2 variants={fadeUp} custom={1} className="text-4xl font-bold text-slate-900 leading-tight">
                Building a Stronger <br />
                <span className="text-accent-green">MSME Ecosystem</span>
              </motion.h2>
              ...
              <motion.div variants={fadeUp} custom={3} className="bg-slate-50 rounded-2xl p-6 border-l-4 border-accent-green">
                ...
                <p className="text-sm text-accent-green font-bold">— Team Ewolyn</p>
              </motion.div>
              <motion.div variants={fadeUp} custom={4}>
                <Link href="/contact" className="inline-flex items-center gap-2 bg-accent-green text-white font-bold px-8 py-4 rounded-xl hover:bg-emerald-600 transition-colors shadow-lg shadow-green-500/20">
