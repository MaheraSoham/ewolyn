  ...
  return (
    <main>
      ...
      <section
        ...
        style={{ background: "linear-gradient(135deg, #0d2f57 0%, #1B4F8C 50%, #0d2f57 100%)" }}
      >
            ...
            {stories.map((s) => (
              ...
              >
                ...
                <div className="p-5 flex flex-col flex-grow">
                  <h3 className="text-base font-black text-[#0a1628] leading-tight">{s.company}</h3>
        ...
        <div className="container-max text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <a
              ...
              className="inline-flex items-center gap-3 rounded-2xl bg-[#2eb85c] text-white font-black px-8 py-4 hover:bg-[#28a550] transition-all shadow-xl shadow-[#2eb85c]/30 text-sm"
            >
