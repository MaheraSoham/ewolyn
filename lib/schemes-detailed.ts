...
export const detailedSchemes: DetailedScheme[] = [
  ...
  {
    slug: "ngo-elevation-program",
    title: "NGO Elevation Program",
    subtitle: "Empowering Social Impact with Maximum Grants",
    tags: ["Social Impact", "Grants", "Compliance"],
    heroDescription: "The NGO Elevation Program provides comprehensive financial, technical, and compliance support for NGOs, Foundations, and Social Enterprises to scale their impact.",
    heroStats: [
      { value: "₹80L", label: "Max Grant" },
      { value: "100%", label: "Compliance Help" },
      { value: "48hrs", label: "Initial Review" },
      { value: "Social", label: "Impact Focused" }
    ],
    readTime: "9 min read",
    ...
    tableOfContents: [
      { id: "introduction", title: "Introduction" },
      { id: "what-is-ngo-extra", title: "What is Elevation Program?" },
      { id: "eligibility", title: "Eligibility" },
      { id: "benefits", title: "Key Benefits" },
      { id: "application-process", title: "Process" },
    ...
    introduction: {
      paragraphs: [
        "The NGO Elevation Program is a specialized initiative designed to bridge the gap between social intent and financial resources. Many NGOs in India struggle not because of a lack of vision, but due to complexities in compliance and grant acquisition.",
        "This program focuses on making NGOs 'grant-ready' by ensuring they meet all regulatory requirements like 12A, 80G, and CSR-1 registrations while connecting them with suitable funding bodies.",
        "With our expert guidance, social organizations can focus on their core mission of creating impact while we handle the intricacies of funding and compliance."
      ],
      quote: "Social change is possible when vision meets sustainable resources. Our program ensures your mission never stops for lack of funds."
    },
    whatIs: {
      title: "What is the NGO Elevation Program?",
      paragraphs: [
        "The NGO Elevation Program is an all-in-one support system for non-profit organizations. It combines consultancy, compliance management, and grant acquisition services into a single, streamlined process.",
        "It covers everything from traditional government grants to modern CSR funding from large corporations. The program is designed to elevate an NGO from a local operation to a professionally managed, fundable entity.",
        "We help NGOs build a strong digital presence, prepare impact reports, and navigate the complex landscape of National and International donor agencies."
      ]
    },
    eligibility: {
      intro: "This program is open to various social impact entities:",
      entities: [
        { title: "Registered NGOs", description: "Societies, Trusts, and Section 8 companies registered in India." },
        { title: "Foundations", description: "Private or public foundations focused on specific social causes." },
        { title: "Social Enterprises", description: "For-profit entities with a primary mission of social or environmental impact." },
        { title: "Educational Trusts", description: "Organizations running schools, colleges, or vocational training centers." }
      ],
      checklist: [
        "Must have a valid registration (Society/Trust/Sec 8).",
        "At least 1 year of operational history (for large grants).",
        "Clear social impact objectives."
      ]
    },
    eligibleProjects: {
      intro: "Grants under this program can be utilized for various social initiatives:",
      projects: [
        { title: "Education & Literacy", description: "Building schools, digital classrooms, or scholarship programs.", icon: "📚" },
        { title: "Healthcare Services", description: "Mobile clinics, health camps, or infrastructure development.", icon: "🏥" },
        { title: "Women Empowerment", description: "Skill development and micro-entrepreneurship for women.", icon: "👩‍💼" },
        { title: "Environmental Protection", description: "Afforestation, waste management, or renewable energy projects.", icon: "🌳" }
      ]
    },
    benefits: {
      highlights: [
        { value: "₹80L", label: "Grant Range", description: "Access grants ranging from ₹10 Lakhs to ₹80 Lakhs based on project scale.", icon: "🪙" },
        { value: "Global", label: "Funding Access", description: "Connect with international donor agencies and CSR funds of MNCs.", icon: "🌍" }
      ],
      lendingInstitutions: ["Government Ministries", "CSR Foundations (Tata, Reliance, etc.)", "International NGOs", "Philanthropic Funds"]
    },
    applicationProcess: {
      steps: [
        { title: "Impact Assessment", description: "We analyze your current social impact and areas for improvement.", cta: "Schedule an assessment" },
        { title: "Compliance Audit", description: "Verification of 12A, 80G, CSR-1, and NITI Aayog registrations." },
        { title: "Proposal Building", description: "Drafting compelling grant proposals and project reports." },
        { title: "Submission & Networking", description: "Submitting proposals to the right portals and connecting with donors." }
      ],
      timeline: "Compliance takes 15-30 days; grant approval varies between 2-4 months."
    },
    documents: {
      list: ["Registration Certificate", "PAN & Aadhaar of Trustees", "12A/80G Certificates", "3 Years Audit Reports", "Social Impact Photos/Videos", "NITI Aayog Darpan ID"],
      note: "Expired registrations must be renewed before grant application. We assist in renewals too."
    },
    commonMistakes: [
      { title: "Documentation Gaps", description: "Lack of proper audit reports or expired 12A/80G status." },
      { title: "Poor Project Design", description: "Vague project objectives without measurable impact metrics." }
    ],
    faqs: [
      { question: "Can a new NGO apply?", answer: "Yes, but they may initially be eligible for smaller local grants or CSR support." },
      { question: "What is CSR-1?", answer: "It is a mandatory registration for NGOs to receive CSR funds from companies in India." }
    ],
    conclusion: {
      paragraphs: ["The NGO Elevation Program is your partner in growth. We simplify the complexities of the social sector so you can do what you do best—saving lives and building a better society.", "With our 90% success rate in compliance and 75% in grant acquisition, your organization is in safe hands."],
      ctaTitle: "Ready to Elevate Your NGO?",
      ctaDescription: "Get a free compliance check and grant eligibility report today."
    }
  },
  {
  ...
  },
  {
    ...
    subtitle: "Fueling Early-Stage Innovation in India",
    tags: ["Innovation", "Early Stage", "Venture"],
    heroDescription: "The Startup India Seed Fund Scheme (SISFS) provides financial assistance to startups for proof of concept, prototype development, product trials, market entry, and commercialization.",
    heroStats: [
      { value: "₹50L", label: "Max Funding" },
      { value: "Equity", label: "Pure Equity/Debt" },
      { value: "DPIIT", label: "Recognition" },
      { value: "Proof", label: "Of Concept" }
    ],
    readTime: "8 min read",
    ...
    tableOfContents: [
      { id: "introduction", title: "Introduction" },
      { id: "eligibility", title: "Eligibility" },
      { id: "usage", title: "Fund Usage" },
      { id: "process", title: "How it Works" },
      { id: "faqs", title: "FAQs" }
    ],
    introduction: {
      paragraphs: [
        "The hardest part of a startup journey is the beginning—when you have an idea but no capital to build a prototype. The Startup India Seed Fund Scheme (SISFS) was created to solve exactly this problem.",
        "Launched by DPIIT, this scheme channels funds through selected incubators across India to support young innovative ventures at their most vulnerable stage.",
        "Unlike VC funding, the Seed Fund is designed to be founder-friendly, focusing more on innovation potential than immediate revenue."
      ],
      quote: "A seed well-planted today grows into the forest of tomorrow. We help you secure that first drop of water for your innovation."
    },
    whatIs: {
      title: "What is the Startup India Seed Fund Scheme?",
      paragraphs: [
        "SISFS is a corpus of ₹945 Crore designed to support 3,600 startups over 4 years. The fund is disbursed via Incubators who act as the first line of evaluation.",
        "It offers up to ₹20 Lakhs as a grant for validation of Proof of Concept/Prototype and up to ₹50 Lakhs as debt/convertible debenture for market entry or commercialization.",
        "It is the perfect stepping stone for startups before they approach Angel Investors or Series A Venture Capitalists."
      ]
    },
    eligibility: {
      intro: "To apply, a startup must meet these strict criteria:",
      entities: [
        { title: "DPIIT Recognized", description: "Must have a valid DPIIT recognition certificate." },
        { title: "Under 2 Years", description: "Startup must not have been incorporated more than 2 years ago at the time of application." },
        { title: "Tech Driven", description: "Must have a business model with a high degree of innovation or scalability." }
      ],
      checklist: [
        "DPIIT Certificate is mandatory.",
        "No more than ₹10 Lakhs of previous funding support received.",
        "At least 51% shareholding by Indian promoters."
      ]
    },
    eligibleProjects: {
      intro: "The fund can be used for:",
      projects: [
        { title: "Prototype Development", description: "Building the first working version of your product.", icon: "🛠️" },
        { title: "Product Trials", description: "Testing with real users to gather data and feedback.", icon: "🧪" },
        { title: "Market Entry", description: "Initial marketing and sales efforts to gain traction.", icon: "🚀" },
        { title: "Certification", description: "Acquiring necessary IP, patents, or industry certifications.", icon: "📜" }
      ]
    },
    benefits: {
      highlights: [
        { value: "₹20L", label: "Grant", description: "Grant for validation of proof of concept and prototype development.", icon: "🎁" },
        { value: "₹50L", label: "Debt/Equity", description: "Funding for market entry and scaling via debt or convertible debentures.", icon: "💹" }
      ],
      lendingInstitutions: ["Empaneled Incubators (IITs, IIMs, Tech Hubs)", "Startup India Portal"]
    },
    applicationProcess: {
      steps: [
        { title: "DPIIT Recognition", description: "Getting your startup registered with the Startup India portal.", cta: "Get DPIIT Recognition Now" },
        { title: "Incubator Selection", description: "Choosing the right incubator that matches your industry and location." },
        { title: "Application Submission", description: "Submitting the pitch deck and financial projections on the SISFS portal." },
        { title: "Incubator Presentation", description: "Presenting your idea to the incubator's selection committee." }
      ],
      timeline: "Typically 45-90 days for evaluation and approval."
    },
    documents: {
      list: ["DPIIT Recognition Certificate", "Pitch Deck", "Financial Projections (3 years)", "Promoter Profiles", "Prototype Sketch/Video", "Company Incorporation Certificate"],
      note: "A strong pitch deck focusing on 'Problem-Solution Fit' is the most critical document."
    },
    commonMistakes: [
      { title: "Weak Pitch Deck", description: "Failing to explain the innovation or the market size clearly." },
      { title: "Old Incorporation", description: "Applying when the startup is older than 2 years." }
    ],
    faqs: [
      { question: "Is this a loan?", answer: "Up to ₹20L can be a grant (no repayment). Above that, it is usually a soft loan or convertible debt." },
      { question: "Can I apply to multiple incubators?", answer: "Yes, you can select up to 3 incubators in your application." }
    ],
    conclusion: {
      paragraphs: ["The Startup India Seed Fund is the best way to kickstart your entrepreneurial journey without giving away too much equity too early.", "We help you through the entire journey—from getting DPIIT recognition to crafting a winning pitch for the incubators."],
      ctaTitle: "Fuel Your Innovation",
      ctaDescription: "Let's build your pitch deck and get you recognized as a DPIIT Startup."
    }
  },
  {
    slug: "tax-exemption-benefits",
    title: "Tax Exemption Benefits",
    subtitle: "Save Capital for Growth with Smart Compliance",
    tags: ["Tax", "Savings", "DPIIT"],
    heroDescription: "Unlock 3 years of Income Tax exemption (80-IAC) and Capital Gains exemptions (Section 54GB) for your startup or MSME.",
    heroStats: [
      { value: "3 Yrs", label: "Tax Holiday" },
      { value: "80-IAC", label: "Exemption" },
      { value: "100%", label: "Income Tax Save" },
      { value: "GST", label: "Benefits" }
    ],
    readTime: "6 min read",
    ...
    tableOfContents: [
      { id: "introduction", title: "Introduction" },
      { id: "80-iac", title: "80-IAC Exemption" },
      { id: "capital-gains", title: "Capital Gains" },
      { id: "eligibility", title: "Eligibility" },
      { id: "process", title: "Process" }
    ],
    introduction: {
      paragraphs: [
        "Taxes can consume a significant portion of a young company's cash flow. The Government of India offers powerful tax 'holidays' and exemptions to help startups reinvest their profits into core growth.",
        "Under Section 80-IAC of the Income Tax Act, eligible startups can avail a 100% tax exemption for any 3 consecutive years out of their first 10 years of incorporation.",
        "Additionally, founders and investors can save on capital gains tax when reinvesting in their own ventures. Understanding these benefits is key to long-term financial health."
      ],
      quote: "A rupee saved in tax is a rupee earned for innovation. Don't pay more than you should."
    },
    whatIs: {
      title: "Major Tax Benefits for Startups & MSMEs",
      paragraphs: [
        "The primary benefit is the 80-IAC exemption, which covers full income tax on profits. Note that MAT (Minimum Alternate Tax) might still apply, but at a reduced rate or with carry-forward benefits.",
        "Section 54GB allows exemption from capital gains tax arising from the sale of residential property if the proceeds are invested in eligible startups.",
        "MSMEs also benefit from lower corporate tax rates (25%) and various state-level GST subsidies based on their location and industry."
      ]
    },
    eligibility: {
      intro: "Tax exemptions are high-stakes, so eligibility is strictly monitored:",
      entities: [
        { title: "DPIIT Startups", description: "Must be recognized by DPIIT and incorporated between 2016 and 2025." },
        { title: "Private Limited/LLP", description: "Only companies and LLPs are eligible (Partnerships are not)." },
        { title: "High Innovation", description: "Must demonstrate high potential for employment or wealth creation." }
      ],
      checklist: [
        "Turnover must not exceed ₹100 Crore in any year.",
        "Must not be formed by splitting or reconstructing an existing business.",
        "Inter-Ministerial Board (IMB) approval is mandatory for 80-IAC."
      ]
    },
    eligibleProjects: {
      intro: "Benefits apply to companies in:",
      projects: [
        { title: "Software & Technology", description: "SaaS, AI, Cybersecurity, and Fintech ventures.", icon: "💻" },
        { title: "Manufacturing", description: "New-age electronics, medical devices, and hardware.", icon: "🏗️" },
        { title: "Green Tech", description: "Renewable energy, EV infrastructure, and recycling.", icon: "🔋" }
      ]
    },
    benefits: {
      highlights: [
        { value: "100%", label: "Income Tax", description: "Zero tax on profits for 3 consecutive financial years.", icon: "📉" },
        { value: "54GB", label: "Cap Gains", description: "Tax-free reinvestment of property sale proceeds into startups.", icon: "🏠" }
      ],
      lendingInstitutions: ["Income Tax Department", "DPIIT", "Ministry of Commerce"]
    },
    applicationProcess: {
      steps: [
        { title: "IMB Application", description: "Applying to the Inter-Ministerial Board through the Startup India portal.", cta: "Start your IMB application" },
        { title: "Innovation Proof", description: "Providing evidence of how your business is uniquely innovative." },
        { title: "Board Review", description: "Presenting or answering queries from the board members." },
        { title: "Certificate Issuance", description: "Getting the formal 80-IAC exemption certificate." }
      ],
      timeline: "IMB approval takes 3-6 months. Plan ahead!"
    },
    documents: {
      list: ["IMB Application Form", "Latest 3 Years Financials", "Detailed Business Plan", "Pitch Deck", "Video of Product (if any)", "Patent applications (if any)"],
      note: "The 'Innovation Summary' is the most scrutinized part of the 80-IAC application."
    },
    commonMistakes: [
      { title: "Vague Innovation", description: "Failing to prove how your startup is different from existing businesses." },
      { title: "Late Application", description: "Applying for 80-IAC after the 10-year window has passed." }
    ],
    faqs: [
      { question: "Is MAT still applicable?", answer: "Yes, MAT is generally applicable but can be offset against future tax liabilities." },
      { question: "What if my company is making a loss?", answer: "You can still get the certificate now and activate the 3-year holiday when you become profitable." }
    ],
    conclusion: {
      paragraphs: ["Tax planning should be done from Day 1, not during the audit season. Securing these certificates early gives you a massive competitive advantage.", "Our tax experts help you draft the 'Innovation Pitch' that the Inter-Ministerial Board expects and ensure your documentation is airtight."],
      ctaTitle: "Stop Leaving Money on the Table",
      ctaDescription: "Get your 80-IAC eligibility report today."
    }
  },
  {
  ...
  },
  {
    ...
    title: "PMEGP Scheme",
    subtitle: "Credit Linked Subsidy for New Enterprises",
    tags: ["Subsidy", "Employment", "New Business"],
    heroDescription: "The Prime Minister's Employment Generation Programme (PMEGP) offers up to 35% subsidy on project costs for setting up new micro-enterprises.",
    heroStats: [
      { value: "₹50L", label: "Max Cost (Mfg)" },
      { value: "35%", label: "Max Subsidy" },
      { value: "15-25%", label: "Equity Scope" },
      { value: "KVIC", label: "Agency" }
    ],
    readTime: "9 min read",
    ...
    tableOfContents: [
      ...
      { id: "eligibility", title: "Eligibility" },
      { id: "subsidy-rates", title: "Subsidy Rates" },
      { id: "process", title: "Process" },
      { id: "faqs", title: "FAQs" }
    ],
    introduction: {
      paragraphs: [
        "PMEGP is a major credit-linked subsidy scheme introduced by the Ministry of MSME to generate employment opportunities in rural and urban areas.",
        "It is implemented by the Khadi and Village Industries Commission (KVIC) at the national level and by DICs and KVIBs at the state level.",
        "The scheme is specifically designed for 'New' units, helping first-time entrepreneurs start their journey with substantial financial backing."
      ],
      quote: "Empowering hands that create. PMEGP is the backbone of India's rural and urban entrepreneurship."
    },
    whatIs: {
      title: "What is PMEGP?",
      paragraphs: [
        "PMEGP is a merger of two erstwhile schemes—PMRY and REGP. It provides margin money subsidy which is locked for 3 years, after which it is adjusted against the loan.",
        "For manufacturing units, the maximum project cost is ₹50 Lakhs. For service units, it is ₹20 Lakhs. The bank provides the remaining 90-95% of the project cost as a loan.",
        "The subsidy ranges from 15% to 35% depending on the candidate's category (General/Special) and the location of the unit (Urban/Rural)."
      ]
    },
    eligibility: {
      intro: "Who can apply for PMEGP?",
      entities: [
        { title: "Individuals", description: "Must be above 18 years. For projects above ₹10L (Mfg) or ₹5L (Service), 8th standard pass is required." },
        { title: "SHGs", description: "Self Help Groups (including those belonging to BPL provided they have not availed benefit under any other scheme)." },
        { title: "Institutions", description: "Institutions registered under Societies Registration Act, 1860." }
      ],
      checklist: [
        "Only for NEW units.",
        "No income ceiling for setting up projects.",
        "Existing units or units already availed subsidy under any other Govt. scheme are not eligible."
      ]
    },
    eligibleProjects: {
      intro: "Eligible activities:",
      projects: [
        { title: "Agro-Based Food Processing", description: "Flour mills, spice processing, fruits and vegetable preservation.", icon: "🌾" },
        { title: "Service Sector", description: "DTP centers, repair workshops, labs, etc.", icon: "🛠️" },
        { title: "Textile", description: "Garment manufacturing, embroidery, and weaving units.", icon: "🧵" }
      ]
    },
    benefits: {
      highlights: [
        { value: "35%", label: "Subsidy", description: "Special category (SC/ST/OBC/Women) in rural areas get 35% subsidy.", icon: "📉" },
        { value: "₹50L", label: "Project Cost", description: "Generous limits for manufacturing setups.", icon: "🏗️" }
      ],
      lendingInstitutions: ["Public Sector Banks", "Regional Rural Banks", "Cooperative Banks", "Private Sector Banks (Selected)"]
    },
    applicationProcess: {
      steps: [
        { title: "Online Application", description: "Filling the application on the KVIC online portal.", cta: "Fill PMEGP Form" },
        { title: "DPI Submission", description: "Uploading the project report and category certificates." },
        { title: "DLTFC Interview", description: "Meeting the District Level Task Force Committee for project presentation." },
        { title: "Bank Sanction", description: "Final appraisal and loan sanction by the financing bank." }
      ],
      timeline: "60-90 days."
    },
    documents: {
      list: ["Aadhaar Card", "Caste Certificate (if applicable)", "Educational Qualification Certificate", "Detailed Project Report (DPR)", "Rural Area Certificate", "Rent/Lease Agreement"],
      note: "EDP (Entrepreneurship Development Program) training is mandatory before the first installment is released."
    },
    commonMistakes: [
      { title: "Applying for Old Units", description: "The scheme strictly forbids funding for existing businesses." },
      { title: "Low Qualification", description: "Applying for large projects without the 8th pass certificate." }
    ],
    faqs: [
      { question: "Is EDP training free?", answer: "Yes, it is provided by the government through various training centers." },
      { question: "What is the lock-in period for subsidy?", answer: "The subsidy is kept in a fixed deposit for 3 years." }
    ],
    conclusion: {
      paragraphs: ["PMEGP is one of the most effective tools for social change through business. It significantly reduces the burden of repayment through its high subsidy model.", "We provide end-to-end support from DPR preparation to EDP coordination and bank follow-ups."],
      ctaTitle: "Start Your First Venture",
      ctaDescription: "Get help with your PMEGP application and project report today."
    }
  },
  {
    slug: "cgtmse-credit-guarantee",
    title: "CGTMSE Guarantee",
    subtitle: "Collateral-Free Loans for MSMEs",
    tags: ["No Collateral", "Guarantee", "MSME"],
    heroDescription: "Credit Guarantee Fund Trust for Micro and Small Enterprises (CGTMSE) provides guarantees to lenders to facilitate collateral-free credit to MSMEs.",
    heroStats: [
      { value: "₹5 Cr", label: "Max Guarantee" },
      { value: "85%", label: "Coverage" },
      { value: "100%", label: "Trust Backed" },
      { value: "Wider", label: "Credit Access" }
    ],
    readTime: "7 min read",
    lastUpdated: "January 25, 2026",
    author: "Ewolyn Team",
    tableOfContents: [
      { id: "introduction", title: "Introduction" },
      { id: "coverage", title: "Extent of Coverage" },
      { id: "eligibility", title: "Eligibility" },
    ...
    introduction: {
      paragraphs: [
        "The biggest hurdle for MSMEs in getting loans is the requirement of 'Collateral' or security. CGTMSE was set up by the Ministry of MSME and SIDBI to solve this exact problem.",
        "Under this scheme, the trust provides a guarantee to the bank. If the borrower defaults, the trust pays a significant portion (75-85%) of the loss to the bank.",
        "This gives banks the confidence to lend to entrepreneurs who have a viable business idea but no property to pledge as security."
      ],
      quote: "Your business idea is your collateral. We help the trust back your vision."
    },
    whatIs: {
      title: "How does CGTMSE work?",
      paragraphs: [
        "CGTMSE is not a loan scheme itself, but a 'Guarantee' scheme. You apply for a loan at a bank and request them to cover it under CGTMSE.",
        "The bank pays a small 'Guarantee Fee' to the trust, which is often passed on to the borrower as part of the interest or as a separate charge.",
        "The maximum credit limit covered is now increased to ₹5 Crore, making it suitable even for medium-sized manufacturing units."
      ]
    },
    eligibility: {
      intro: "Eligible borrowers:",
      entities: [
        { title: "New & Existing MSMEs", description: "Both new startups and existing units expanding their operations." },
        { title: "Retailers", description: "Retail trade activities are also covered under specific categories." },
        { title: "Service Providers", description: "IT, healthcare, education, and professional services." }
      ],
      checklist: [
        "Must qualify as per MSME definition (Udyam Registration).",
        "Credit facility should be within the limit of ₹500 Lakhs.",
        "Lender should be a Member Lending Institution (MLI) of CGTMSE."
      ]
    },
    eligibleProjects: {
      intro: "Types of credit covered:",
      projects: [
        { title: "Term Loan", description: "For purchase of machinery, equipment, or building construction.", icon: "🏗️" },
        { title: "Working Capital", description: "To manage day-to-day operational expenses and inventory.", icon: "💵" },
        { title: "Hybrid Security", description: "Partial collateral and partial CGTMSE coverage is also possible.", icon: "⚖️" }
      ]
    },
    benefits: {
      highlights: [
        { value: "85%", label: "Guarantee", description: "For micro enterprises (up to ₹5L) and women entrepreneurs.", icon: "🛡️" },
        { value: "₹5 Cr", label: "Limit", description: "High coverage for significant business scaling.", icon: "📈" }
      ],
      lendingInstitutions: ["Public Sector Banks", "Select Private Banks", "Regional Rural Banks", "SIDBI", "NBFCs"]
    },
    applicationProcess: {
      steps: [
        { title: "Project Proposal", description: "Preparing a detailed project report and funding requirement.", cta: "Draft your project report" },
        { title: "Bank Selection", description: "Approaching an MLI bank that is active in CGTMSE lending." },
        { title: "Sanction", description: "The bank evaluates the project and sanctions the loan 'In-Principle'." },
        { title: "CGTMSE Cover", description: "Bank applies to CGTMSE for guarantee cover and pays the fee." }
      ],
      timeline: "30-45 days."
    },
    documents: {
      list: ["Udyam Registration Certificate", "Detailed Project Report", "Financial Statements", "Bank Statements", "Business Proof", "KYC of Promoters"],
      note: "The bank's internal credit rating plays a crucial role in getting CGTMSE cover."
    },
    commonMistakes: [
      { title: "No Udyam", description: "Failing to have a valid Udyam registration." },
      { title: "Poor CIBIL", description: "Assuming collateral-free means credit history doesn't matter (it matters MORE)." }
    ],
    faqs: [
      { question: "Can I get a loan without any property?", answer: "Yes, that is the primary purpose of CGTMSE." },
      { question: "What is the guarantee fee?", answer: "It ranges from 0.37% to 1.35% per annum depending on the loan size." }
    ],
    conclusion: {
      paragraphs: ["CGTMSE has unlocked billions in credit for small businesses that were previously ignored by banks.", "We help you identify the right banks and prepare the high-quality project reports that banks need to feel comfortable with collateral-free lending."],
      ctaTitle: "No Collateral? No Problem.",
      ctaDescription: "Let's find the right bank to back your business under CGTMSE."
    }
  },
  {
